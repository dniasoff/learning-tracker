...
**Scope:** Complete flow, state, and copy specification for the local-born → cloud-born upgrade flow defined in `offline-first-architecture-v2-2026-04-10.md` §4.3. Visual design (wireframes, component choices, spacing, iconography) is explicitly out of scope here — handed off to the UX designer agent.
...
- **Canonical architecture doc:** `_bmad-output/planning-artifacts/offline-first-architecture-v2-2026-04-10.md`
