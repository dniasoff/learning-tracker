...
- [Source: _bmad-output/project-context.md#Error Handling] — Try-catch, error messages
- [Source: _bmad-output/project-context.md#drift Database Patterns] — Query patterns
