...
- Widget tests for critical UI flows [Source: _bmad-output/project-context.md]
...
- [Source: _bmad-output/project-context.md#Framework-Specific Rules] — Riverpod patterns
