...
class AppTextStyles {
  ...
  static TextStyle get hebrewHeadlineLarge => headlineLarge.copyWith(
        fontFamily: _hebrewFontFamily,
      );

  static TextStyle get hebrewHeadlineMedium => headlineMedium.copyWith(
        fontFamily: _hebrewFontFamily,
      );

  static TextStyle get hebrewHeadlineSmall => headlineSmall.copyWith(
        fontFamily: _hebrewFontFamily,
      );

  static TextStyle get hebrewTitleLarge => titleLarge.copyWith(
        fontFamily: _hebrewFontFamily,
      );

  static TextStyle get hebrewTitleMedium => titleMedium.copyWith(
        fontFamily: _hebrewFontFamily,
      );

  static TextStyle get hebrewTitleSmall => titleSmall.copyWith(
        fontFamily: _hebrewFontFamily,
      );
