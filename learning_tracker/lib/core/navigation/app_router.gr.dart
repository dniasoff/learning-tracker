...
class TrackDetailRouteArgs {
  ...
  @override
  String toString() {
    return 'TrackDetailRouteArgs{key: $key, curriculumId: $curriculumId, trackType: $trackType}';
  }
  ...
  @override
  int get hashCode => key.hashCode ^ curriculumId.hashCode ^ trackType.hashCode;
}
