...
class LifetimeTreeBuilder {
  ...
  Set<String> computeLearnedLeafRefs({
    ...
    for (final leaf in leaves) {
      ...
      // level2/level3/level4 marks are stored with a QUALIFIED path id
      // (collision fix: bare daf '2' credited every masechta; bare perek '1'
      // credited every sefer). Match against the leaf's qualified id; only
      // level1 (curriculum root) stays bare.
