...
class _AchievementTierCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return _LockedAchievementShell(
      l10n: l10n,
...
/// Blur + lock overlay for milestones the learner has not unlocked yet.
class _LockedAchievementShell extends StatelessWidget {
  const _LockedAchievementShell({
    required this.child,
    required this.l10n,
