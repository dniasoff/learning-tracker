...
/// Values: 'hebrew' or 'gregorian' (default).
 String get dateType;/// Goal mode: 'deadline' (default) or 'pace'.
 ...
 String? get paceUnit; DateTime get createdAt; DateTime get updatedAt;
...
@override
int get hashCode => Object.hash(runtimeType,id,curriculumId,targetPercent,targetDate,description,dateType,goalType,paceValue,paceUnit,createdAt,updatedAt);

@override
String toString() {
  return 'GoalEntity(id: $id, curriculumId: $curriculumId, targetPercent: $targetPercent, targetDate: $targetDate, description: $description, dateType: $dateType, goalType: $goalType, paceValue: $paceValue, paceUnit: $paceUnit, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 int? id, CurriculumId curriculumId, double targetPercent, DateTime? targetDate, String description, String dateType, String goalType, int? paceValue, String? paceUnit, DateTime createdAt, DateTime updatedAt
});
...
/// Create a copy of GoalEntity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? curriculumId = null,Object? targetPercent = null,Object? targetDate = freezed,Object? description = null,Object? dateType = null,Object? goalType = null,Object? paceValue = freezed,Object? paceUnit = freezed,Object? createdAt = null,Object? updatedAt = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? id,  CurriculumId curriculumId,  double targetPercent,  DateTime? targetDate,  String description,  String dateType,  String goalType,  int? paceValue,  String? paceUnit,  DateTime createdAt,  DateTime updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _GoalEntity() when $default != null:
return $default(_that.id,_that.curriculumId,_that.targetPercent,_that.targetDate,_that.description,_that.dateType,_that.goalType,_that.paceValue,_that.paceUnit,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int? id,  CurriculumId curriculumId,  double targetPercent,  DateTime? targetDate,  String description,  String dateType,  String goalType,  int? paceValue,  String? paceUnit,  DateTime createdAt,  DateTime updatedAt)  $default,) {final _that = this;
switch (_that) {
case _GoalEntity():
return $default(_that.id,_that.curriculumId,_that.targetPercent,_that.targetDate,_that.description,_that.dateType,_that.goalType,_that.paceValue,_that.paceUnit,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int? id,  CurriculumId curriculumId,  double targetPercent,  DateTime? targetDate,  String description,  String dateType,  String goalType,  int? paceValue,  String? paceUnit,  DateTime createdAt,  DateTime updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _GoalEntity() when $default != null:
return $default(_that.id,_that.curriculumId,_that.targetPercent,_that.targetDate,_that.description,_that.dateType,_that.goalType,_that.paceValue,_that.paceUnit,_that.createdAt,_that.updatedAt);case _:
  return null;
...
class _GoalEntity extends GoalEntity {
  const _GoalEntity({this.id, required this.curriculumId, this.targetPercent = 100.0, this.targetDate, this.description = '', this.dateType = 'gregorian', this.goalType = 'deadline', this.paceValue, this.paceUnit, required this.createdAt, required this.updatedAt}): super._();
...
/// Create a copy of GoalEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? curriculumId = null,Object? targetPercent = null,Object? targetDate = freezed,Object? description = null,Object? dateType = null,Object? goalType = null,Object? paceValue = freezed,Object? paceUnit = freezed,Object? createdAt = null,Object? updatedAt = null,}) {
