...
@ProviderFor(hebrewNameForRef)
final hebrewNameForRefProvider = HebrewNameForRefFamily._();
...
final class HebrewNameForRefProvider
  ...
  /// curriculum hierarchies haven't loaded yet — callers should fall back
  /// to the prettified English ref in that case.
  HebrewNameForRefProvider._({
    required HebrewNameForRefFamily super.from,
    required String super.argument,
  }) : super(
         retry: null,
         name: r'hebrewNameForRefProvider',
         isAutoDispose: true,
         dependencies: null,
         $allTransitiveDependencies: null,
       );
  ...
  @override
  String debugGetCreateSourceHash() => _$hebrewNameForRefHash();

  @override
  String toString() {
    return r'hebrewNameForRefProvider'
        ''
        '($argument)';
  }
  ...
  FutureOr<String?> create(Ref ref) {
    ...
    return hebrewNameForRef(ref, argument);
  }

  @override
  bool operator ==(Object other) {
    return other is HebrewNameForRefProvider && other.argument == argument;
  }
...
String _$hebrewNameForRefHash() => r'e9108b3889324ac3bab1b1d81b91599462b0ac96';
...
final class HebrewNameForRefFamily extends $Family
    with $FunctionalFamilyOverride<FutureOr<String?>, String> {
  HebrewNameForRefFamily._()
    : super(
        retry: null,
        name: r'hebrewNameForRefProvider',
        dependencies: null,
  ...
  HebrewNameForRefProvider call(String sefariaRef) =>
      HebrewNameForRefProvider._(argument: sefariaRef, from: this);
