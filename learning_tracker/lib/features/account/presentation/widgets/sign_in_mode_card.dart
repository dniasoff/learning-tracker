...
///
/// Displays one of three states based on the detected sign-in mode:
...
enum RegistryMatchKind { none, cloudBorn, notOnDevice }

/// Hint that drives which [SignInModeCard] variant is shown.
enum SignInModeHint { cloud, cloudOffline, unknown }
