...
void main() {
  group(
    'Story 20.3 -- TrackProgress Domain Models',
    () {
      // ── Enum cardinality ──
      ...
      group('Enum cardinality', () {
        test('TrackProgressVariant has exactly 4 values', () {
          ...
          expect(TrackProgressVariant.values, containsAll([
        ...
        test('MomentumLevel has exactly 4 values', () {
          ...
          expect(MomentumLevel.values, containsAll([
        ...
        test('CalendarStatus has exactly 3 values', () {
          ...
          expect(CalendarStatus.values, containsAll([
        ...
        test('ChazaraSource has exactly 2 values', () {
          ...
          expect(ChazaraSource.values, containsAll([
            ChazaraSource.prescribed,
            ChazaraSource.userConfigured,
          ]));
        });
      });
