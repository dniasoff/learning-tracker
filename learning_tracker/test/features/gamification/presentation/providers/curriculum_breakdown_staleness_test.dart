...
void main() {
  group(
    'curriculumBreakdownProvider — rebuild after completionCommitted '
    '(DG-BRKD-01)',
    () {
      test(
        'curriculumBreakdownProvider is invalidated (re-evaluated) after '
        'completionCommittedProvider increments',
        () async {
          final db = inMemoryDb();
