...
void main() {
  group('ILP-01: itemsLearnedDataProvider reacts to completionCommittedProvider', () {
    test(
  ...
  group('ILP-01: lifetimeViewDataProvider reacts to completionCommittedProvider', () {
    test(
      'provider re-executes after completionCommittedProvider tick',
      () async {
        int callCount = 0;
  ...
  group('ILP-01: itemsLearnedSummariesProvider reacts to completionCommittedProvider', () {
    test(
