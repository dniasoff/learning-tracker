...
void main() {
  group('scopeUnitIdentifier', () {
    test('level1 and level2 are bare (unique within a curriculum)', () {
      expect(
    ...
    test('scopeUnitIdentifierForItem mirrors scopeUnitIdentifier', () {
      ...
      expect(scopeUnitIdentifierForItem(item, 2), 'Berakhos');
      expect(
  ...
  group('computeLearnedLeafRefs — level3 cross-masechta collision', () {
    ...
    test('a bare daf-2 mark no longer credits any leaf (legacy id ignored)', () {
