...
/// test — which controls the read timeline via `_ControlledRepository`
/// rather than real content — must override `contentRepositoryProvider`
/// too, or the real asset-backed implementation would try to load JSON
/// bundles here.
