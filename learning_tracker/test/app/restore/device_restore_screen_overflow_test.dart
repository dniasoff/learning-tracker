...
// ── Overrides for the null-service navigation path ─────────────────────────────
//
...
List<Override> _statusOverride(RestoreStatus status) => [
  ...
  routerProvider.overrideWithValue(makeStubAppRouter()),
];
