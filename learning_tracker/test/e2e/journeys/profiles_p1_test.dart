...
Future<int> _seedSecondProfile(
  ...
  // T-45/T-47 class (CI remediation round 4): P2-2's eager-mint policy means
  // a real seeded profile always has a ulid; a null one hard-throws out of
  // `ProfileModel.fromDriftRow` (P2-3) the moment profileListProvider (or
  // any other FUTURE-based read) touches this row. A separate write because
  // `profileId` is auto-generated by the insert itself.
  await (db.update(db.learnerProfiles)..where((t) => t.id.equals(profileId)))
