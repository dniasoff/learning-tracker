...
void main() {
  ...
  // --------------------------------------------------------------------------
  // AC1 — Schema migration: fresh DB at schemaVersion 20, all tables exist,
