...
void main() {
  ...
  // --------------------------------------------------------------------------
  // AC1 — Schema migration: fresh DB at schemaVersion 21, all tables exist,
