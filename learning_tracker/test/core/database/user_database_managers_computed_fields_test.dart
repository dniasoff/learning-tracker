...
void main() {
  ...
  Future<int> makeAccount({String email = 'cf@test.local'}) =>
  ...
  group('accounts annotation composer fields', () {
    ...
    test('computedField firebaseUid', () async {
      final field =
          db.managers.accounts.computedField((a) => a.firebaseUid);
      final rows = await db.managers.accounts.withFields([field]).get();
      expect(rows, isNotEmpty);
    });
    ...
    test('computedField displayName', () async {
      final field =
          db.managers.accounts.computedField((a) => a.displayName);
      final rows = await db.managers.accounts.withFields([field]).get();
      expect(rows, isNotEmpty);
    });
  ...
  group('learnerProfiles annotation composer fields', () {
    ...
    test('computedField displayName', () async {
      final field = db.managers.learnerProfiles
          .computedField((a) => a.displayName);
      final rows =
    ...
    test('computedField createdAt', () async {
      final field =
          db.managers.learnerProfiles.computedField((a) => a.createdAt);
      final rows =
          await db.managers.learnerProfiles.withFields([field]).get();
      expect(rows, isNotEmpty);
    });
  ...
  group('curriculumTracks annotation composer fields', () {
    ...
    test('computedField curriculumId', () async {
      final field =
          db.managers.curriculumTracks.computedField((a) => a.curriculumId);
      final rows =
    ...
    test('computedField activatedAt', () async {
      final field =
          db.managers.curriculumTracks.computedField((a) => a.activatedAt);
      final rows =
          await db.managers.curriculumTracks.withFields([field]).get();
      expect(rows, isNotEmpty);
    });
  ...
  group('curriculumScopes annotation composer fields', () {
    ...
    test('computedField curriculumId', () async {
      final field =
          db.managers.curriculumScopes.computedField((a) => a.curriculumId);
      final rows =
    ...
    test('computedField scopeValue', () async {
      final field =
          db.managers.curriculumScopes.computedField((a) => a.scopeValue);
      final rows =
          await db.managers.curriculumScopes.withFields([field]).get();
      expect(rows, isNotEmpty);
    });
    ...
    test('computedField createdAt', () async {
      final field =
          db.managers.curriculumScopes.computedField((a) => a.createdAt);
      final rows =
          await db.managers.curriculumScopes.withFields([field]).get();
      expect(rows, isNotEmpty);
    });
  ...
  group('profilePrograms annotation composer fields', () {
    ...
    test('computedField curriculumType', () async {
      final field = db.managers.profilePrograms
          .computedField((a) => a.curriculumType);
      final rows =
  ...
  group('stageDefinitions annotation composer fields', () {
    ...
    test('computedField stageName', () async {
      final field =
          db.managers.stageDefinitions.computedField((a) => a.stageName);
      final rows =
          await db.managers.stageDefinitions.withFields([field]).get();
      expect(rows, isNotEmpty);
    });
  ...
  group('pointConfigs annotation composer fields', () {
    ...
    test('computedField curriculumId', () async {
      final field =
          db.managers.pointConfigs.computedField((a) => a.curriculumId);
    ...
    test('computedField points', () async {
      final field =
          db.managers.pointConfigs.computedField((a) => a.points);
      final rows = await db.managers.pointConfigs.withFields([field]).get();
      expect(rows, isNotEmpty);
    });
  });
  ...
  group('studyDayConfigs annotation composer fields', () {
    ...
    test('computedField dayOfWeek', () async {
      final field =
          db.managers.studyDayConfigs.computedField((a) => a.dayOfWeek);
      final rows =
    ...
    test('computedField updatedAt', () async {
      final field =
          db.managers.studyDayConfigs.computedField((a) => a.updatedAt);
      final rows =
          await db.managers.studyDayConfigs.withFields([field]).get();
      expect(rows, isNotEmpty);
    });
  ...
  group('completions annotation composer fields', () {
    ...
    test('computedField sefariaRef', () async {
      final field =
          db.managers.completions.computedField((a) => a.sefariaRef);
    ...
    test('computedField completedAt', () async {
      final field =
          db.managers.completions.computedField((a) => a.completedAt);
      final rows = await db.managers.completions.withFields([field]).get();
      expect(rows, isNotEmpty);
    });
  });
  ...
  group('completionEvents annotation composer fields', () {
    ...
    test('computedField sefariaRef', () async {
      final field =
          db.managers.completionEvents.computedField((a) => a.sefariaRef);
      final rows =
    ...
    test('computedField eventTimestamp', () async {
      final field = db.managers.completionEvents
          .computedField((a) => a.eventTimestamp);
      final rows =
          await db.managers.completionEvents.withFields([field]).get();
      expect(rows, isNotEmpty);
    });
  ...
  group('dailyPlans annotation composer fields', () {
    ...
    test('computedField sefariaRef', () async {
      final field =
          db.managers.dailyPlans.computedField((a) => a.sefariaRef);
    ...
    test('computedField priority', () async {
      final field =
          db.managers.dailyPlans.computedField((a) => a.priority);
      final rows = await db.managers.dailyPlans.withFields([field]).get();
      expect(rows, isNotEmpty);
    });
  });
  ...
  group('learningLedger annotation composer fields', () {
    ...
    test('computedField curriculumId', () async {
      final field =
          db.managers.learningLedger.computedField((a) => a.curriculumId);
      final rows =
    ...
    test('computedField entryScope', () async {
      final field =
          db.managers.learningLedger.computedField((a) => a.entryScope);
      final rows =
          await db.managers.learningLedger.withFields([field]).get();
      expect(rows, isNotEmpty);
    });
    ...
    test('computedField unitDisplayNameHe', () async {
      final field = db.managers.learningLedger
          .computedField((a) => a.unitDisplayNameHe);
      final rows =
          await db.managers.learningLedger.withFields([field]).get();
      expect(rows, isNotEmpty);
    });
  ...
  group('bookmarks annotation composer fields', () {
    ...
    test('computedField sefariaRef', () async {
      final field =
          db.managers.bookmarks.computedField((a) => a.sefariaRef);
    ...
    test('computedField updatedAt', () async {
      final field =
          db.managers.bookmarks.computedField((a) => a.updatedAt);
      final rows = await db.managers.bookmarks.withFields([field]).get();
      expect(rows, isNotEmpty);
    });
  });
  ...
  group('learningOrder annotation composer fields', () {
    ...
    test('computedField sefariaRef', () async {
      final field =
          db.managers.learningOrder.computedField((a) => a.sefariaRef);
      final rows =
          await db.managers.learningOrder.withFields([field]).get();
      expect(rows, isNotEmpty);
    });
    ...
    test('computedField userSortOrder', () async {
      final field =
          db.managers.learningOrder.computedField((a) => a.userSortOrder);
      final rows =
          await db.managers.learningOrder.withFields([field]).get();
      expect(rows, isNotEmpty);
    });
  ...
  group('trackLearningOrder annotation composer fields', () {
    ...
    test('computedField sefariaRef', () async {
      final field =
          db.managers.trackLearningOrder.computedField((a) => a.sefariaRef);
      final rows =
    ...
    test('computedField sortOrder', () async {
      final field =
          db.managers.trackLearningOrder.computedField((a) => a.sortOrder);
      final rows =
          await db.managers.trackLearningOrder.withFields([field]).get();
      expect(rows, isNotEmpty);
    });
  ...
  group('goals annotation composer fields', () {
    ...
    test('computedField curriculumId', () async {
      final field =
          db.managers.goals.computedField((a) => a.curriculumId);
  ...
  group('streaks annotation composer fields', () {
    ...
    test('computedField currentStreak', () async {
      final field =
          db.managers.streaks.computedField((a) => a.currentStreak);
    ...
    test('computedField gracePeriodDays', () async {
      final field =
          db.managers.streaks.computedField((a) => a.gracePeriodDays);
      final rows = await db.managers.streaks.withFields([field]).get();
      expect(rows, isNotEmpty);
    });
  });
  ...
  group('streakEvents annotation composer fields', () {
    ...
    test('computedField eventTimestamp', () async {
      final field =
          db.managers.streakEvents.computedField((a) => a.eventTimestamp);
    ...
    test('computedField clientDeviceId', () async {
      final field =
          db.managers.streakEvents.computedField((a) => a.clientDeviceId);
      final rows = await db.managers.streakEvents.withFields([field]).get();
      expect(rows, isNotEmpty);
    });
  });
  ...
  group('syncQueue annotation composer fields', () {
    ...
    test('computedField operationType', () async {
      final field =
          db.managers.syncQueue.computedField((a) => a.operationType);
    ...
    test('computedField retryCount', () async {
      final field =
          db.managers.syncQueue.computedField((a) => a.retryCount);
      final rows = await db.managers.syncQueue.withFields([field]).get();
      expect(rows, isNotEmpty);
    });
  });
  ...
  group('textDownloadStatuses annotation composer fields', () {
    ...
    test('computedField curriculumId', () async {
      final field = db.managers.textDownloadStatuses
          .computedField((a) => a.curriculumId);
      final rows =
    ...
    test('computedField downloadedAt', () async {
      final field = db.managers.textDownloadStatuses
          .computedField((a) => a.downloadedAt);
      final rows =
          await db.managers.textDownloadStatuses.withFields([field]).get();
      expect(rows, isNotEmpty);
    });
    ...
    test('computedField storedItemCount', () async {
      final field = db.managers.textDownloadStatuses
          .computedField((a) => a.storedItemCount);
      final rows =
          await db.managers.textDownloadStatuses.withFields([field]).get();
      expect(rows, isNotEmpty);
    });
  ...
  group('outbox annotation composer fields', () {
    ...
    test('computedField entityKind', () async {
      final field =
          db.managers.outbox.computedField((a) => a.entityKind);
    ...
    test('computedField lastAttemptAt', () async {
      final field =
          db.managers.outbox.computedField((a) => a.lastAttemptAt);
      final rows = await db.managers.outbox.withFields([field]).get();
      expect(rows, isNotEmpty);
    });
  });
  ...
  group('sacredWindowEntries annotation composer fields', () {
    ...
    test('computedField startUtc', () async {
      final field =
          db.managers.sacredWindowEntries.computedField((a) => a.startUtc);
      final rows =
    ...
    test('computedField endUtc', () async {
      final field =
          db.managers.sacredWindowEntries.computedField((a) => a.endUtc);
      final rows =
          await db.managers.sacredWindowEntries.withFields([field]).get();
      expect(rows, isNotEmpty);
    });
    ...
    test('computedField kind', () async {
      final field =
          db.managers.sacredWindowEntries.computedField((a) => a.kind);
      final rows =
          await db.managers.sacredWindowEntries.withFields([field]).get();
      expect(rows, isNotEmpty);
    });
    ...
    test('computedField inIsrael', () async {
      final field =
          db.managers.sacredWindowEntries.computedField((a) => a.inIsrael);
      final rows =
          await db.managers.sacredWindowEntries.withFields([field]).get();
      expect(rows, isNotEmpty);
    });
    ...
    test('computedField createdAt', () async {
      final field =
          db.managers.sacredWindowEntries.computedField((a) => a.createdAt);
      final rows =
          await db.managers.sacredWindowEntries.withFields([field]).get();
      expect(rows, isNotEmpty);
    });
