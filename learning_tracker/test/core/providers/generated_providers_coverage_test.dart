...
void main() {
  ...
  group('auth provider instances', () {
    test('googleSignInProvider debugGetCreateSourceHash', () {
      // covers lines 13, 18-19, 29-30
      expect(googleSignInProvider.debugGetCreateSourceHash(), isNotEmpty);
    });

    test('authRepositoryProvider debugGetCreateSourceHash', () {
      // covers lines 54, 59-60, 71
