export const meta = {
  name: 'device-e2e-full-suite-run7',
...
const OUT = REPO + '/docs/test-artifacts/device-audit-run7';
...
const synth = await agent([
  ...
  ``,
  `Run: comprehensive 3-device parallel on-device E2E re-audit (run 7 — fresh validation pass) of the Learning Tracker Android app. Build = current dev HEAD (all fixes from runs 1-6 + a fully clean CI gate (10,370 tests, analyze, format, make audit all green) included; this run validates them).`,
  `Coverage: ${coverage}`,
  ``,
