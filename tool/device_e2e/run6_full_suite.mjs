export const meta = {
  name: 'device-e2e-full-suite-run6',
...
const OUT = REPO + '/docs/test-artifacts/device-audit-run6';
...
const synth = await agent([
  ...
  ``,
  `Run: comprehensive 3-device parallel on-device E2E re-audit (run 6 — fresh validation pass) of the Learning Tracker Android app. Build = current dev HEAD (all fixes from runs 1-5 + deferred items + a clean test suite (10,370 passing, make audit green) included; this run validates them).`,
  `Coverage: ${coverage}`,
  ``,
