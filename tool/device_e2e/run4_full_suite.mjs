...
return await runFullSuite({
  runNum: 4,
  reportIntro: `Run: comprehensive 3-device parallel on-device E2E re-audit (run 4 — fresh validation pass) of the Learning Tracker Android app. Build = current dev HEAD (all 49 fixes from runs 1-3 included; this run validates them).`,
