...
return await runFullSuite({
  runNum: 2,
  reportIntro: `Run: comprehensive 3-device parallel on-device E2E re-audit (run 2) of the Learning Tracker Android app. Build = current dev HEAD (all 5 run-1 fixes included).`,
