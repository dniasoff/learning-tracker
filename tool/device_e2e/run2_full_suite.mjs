export const meta = {
  name: 'device-e2e-full-suite-run2',
...
const OUT = REPO + '/docs/test-artifacts/device-audit-run2';
...
const synth = await agent([
  ...
  ``,
  `Run: comprehensive 3-device parallel on-device E2E re-audit (run 2) of the Learning Tracker Android app. Build = current dev HEAD (all 5 run-1 fixes included).`,
  `Coverage: ${coverage}`,
  ``,
