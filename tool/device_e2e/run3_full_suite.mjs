...
const OUT = REPO + '/docs/test-artifacts/device-audit-run3';
...
const synth = await agent([
  ...
  ``,
  `Run: comprehensive 3-device parallel on-device E2E re-audit (run 3 — fresh validation pass) of the Learning Tracker Android app. Build = current dev HEAD (all 32 fixes from runs 1+2 included; this run validates them).`,
  `Coverage: ${coverage}`,
  ``,
