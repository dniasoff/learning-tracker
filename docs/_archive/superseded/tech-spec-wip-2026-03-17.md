...
created: '2026-03-17'
archived: '2026-04-19'
status: 'archived — scope shipped under Epics 18 & 21'
stepsCompleted: [1]
...
# Tech-Spec: Multi-Profile Onboarding with Learning Program Wizard (ARCHIVED)

> ⚠️ **ARCHIVED — 2026-04-19.** This was a WIP tech spec written 2026-03-17 covering multi-profile support, learning program wizard, improved bulk mark, Dirshu test tracking, and child-mode UX. The scope has since shipped across **Epic 18** (Onboarding & Track Management Overhaul, in review) and **Epic 21** (Multi-Account Device & Profiles, done). This file is preserved as a historical planning artifact; it should not be used for current implementation.
>
> **For current state:** [`../../planning/epics.md`](../../planning/epics.md), [`../../linear-status.md`](../../linear-status.md).
