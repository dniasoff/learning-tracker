...
- [Source: docs/_archive/tooling-notes/project-context.md#Firebase Integration] — Firebase Auth patterns
- [Source: docs/_archive/tooling-notes/project-context.md#Error Handling] — User-facing error messages
