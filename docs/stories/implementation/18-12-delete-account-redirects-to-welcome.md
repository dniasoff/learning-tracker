...
- [Source: docs/_archive/tooling-notes/project-context.md#auto_route Navigation] — Route patterns, replaceAll
- [Source: docs/_archive/tooling-notes/project-context.md#Firebase Integration] — Auth, account deletion
