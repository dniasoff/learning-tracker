...
- `docs/stories/implementation/19-2-two-database-split.md` -- ContentDatabase, SeedMetadata table definition
- `docs/stories/implementation/19-3-seed-database-build-tool.md` -- SeedManager runtime section (T9, T10), seed asset format
- `docs/stories/implementation/19-6-startup-sequence-hardening.md` -- Startup sequence integration (T5), contentDbPathProvider
- `docs/stories/implementation/seed-database-build-tool-design.md` -- Schema generation strategy, ContentDatabase class design
- `docs/planning/architecture-offline-v2.md` -- §4.4 Content DB Versioning
