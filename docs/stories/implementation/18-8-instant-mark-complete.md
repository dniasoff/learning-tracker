...
- Completions are append-only (INSERT only, no UPDATE/DELETE) [Source: docs/_archive/tooling-notes/project-context.md]
...
- [Source: docs/_archive/tooling-notes/project-context.md#Performance Considerations] — const constructors, avoid rebuilds
- [Source: docs/_archive/tooling-notes/project-context.md#Completion Immutability] — append-only, stage progression
