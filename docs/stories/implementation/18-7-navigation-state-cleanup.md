...
- [Source: docs/_archive/tooling-notes/project-context.md#auto_route Navigation] — Route patterns
- [Source: docs/_archive/tooling-notes/project-context.md#Code Generation Workflow] — build_runner requirements
