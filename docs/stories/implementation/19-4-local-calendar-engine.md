...
- [Calendar Cycle Computation Analysis](../../docs/planning/calendar-cycle-computation-analysis.md) -- full technical analysis of all 12 programs, bugs found, schema design
- [Two-Database Drift Architecture](../../docs/planning/two-database-drift-architecture.md) -- ContentDatabase design, CalendarCycleDao specification
- [Seed Database Build Tool Design](../../docs/stories/implementation/seed-database-build-tool-design.md) -- CalendarCycles table schema, seed population
- [Architecture Decisions D9](../../docs/planning/architecture.md) -- D9: Local Calendar Engine decision
...
- Re-verified 2026-07-13 against the live tree: `LocalCalendarEngine` is shipped at `lib/features/scheduler/domain/services/local_calendar_engine.dart`, querying the seed-populated `CalendarCycles` table in `ContentDatabase`.
- Acceptance coverage: `test/story_acceptance/epic_19_offline_first_test.dart`, group `Story 19.4 — Local Calendar Engine`, 0 `skip:` markers.
...
- `learning_tracker/lib/features/scheduler/domain/services/local_calendar_engine.dart`
