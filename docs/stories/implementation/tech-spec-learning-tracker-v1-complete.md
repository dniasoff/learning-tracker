...
status: 'historical — superseded by shipped v1'
...
> ⚠️ **HISTORICAL — 2026-04-19 review.** This spec was written on 2026-01-03 as the initial v1 blueprint. It predates Epic 19 (two-database split), Epic 21 (multi-account device), and Epic 23 (hard-tier auth refactor). References to "Riverpod 2.0+" (code is 3.x), "3-stage learning cycle" as a hardcoded assumption (stages are now configurable), "one user per account" (multi-profile shipped), and single-database architecture are no longer accurate. The spec captures the original product vision but should not be used for current implementation guidance.
>
> **For current state:** [`../../project-overview.md`](../../project-overview.md), [`../../planning/architecture-design.md`](../../planning/architecture-design.md), [`../../planning/architecture-offline-v2.md`](../../planning/architecture-offline-v2.md).
...
| File | Purpose |
| ---- | ------- |
| `docs/planning/product-brief-learning-tracker-2026-01-03.md` | Complete product vision and user requirements |
