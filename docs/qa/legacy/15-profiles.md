...
> ⚠️ **Historical reconstruction — 2026-04-19.** Multi-profile support was never tracked as a discrete Linear epic (the original "Epic 15" design stories were delivered piecewise across **Epic 18** (Onboarding & Track Management Overhaul) and **Epic 21** (Multi-Account Device). This test plan was written on 2026-04-13 as a post-implementation reconstruction of what shipped, not as a pre-implementation story spec. Verify each scenario against current code in `lib/features/profiles/`, `lib/features/auth/`, and the `DeviceRegistryDatabase` before relying on it for QA sign-off. See [`../../_archive/scrapped-ideas/epic-15-multi-profile-original-stories.md`](../../_archive/scrapped-ideas/epic-15-multi-profile-original-stories.md) for the mapping.
