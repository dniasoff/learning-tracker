...
> ⚠️ **HISTORICAL — 2026-04-19.** This roadmap was prepared on 2026-03-18 as the pre-launch plan. V1 shipped on 2026-04-15 (Android). The "three user types" framing (Learner / Child / Parent) has since been generalized into **profiles with modes** (child / adult, up to 10 profiles per account). Multi-account device support (Epic 21) added a fourth axis that isn't covered here. For current state and active roadmap, see [`../linear-status.md`](../linear-status.md) and [`epics.md`](epics.md). This file is preserved as a historical record of the pre-launch plan.

**Target Release:** April 18th, 2026 (iOS + Android) — shipped 2026-04-15 (Android only)
**Prepared:** March 18th, 2026
**For:** New developer onboarding (pre-launch)
...
- Read architecture docs: [`docs/planning/architecture-design.md`](architecture-design.md)
- Read project context: [`docs/_archive/tooling-notes/project-context.md`](../_archive/tooling-notes/project-context.md) (120+ rules — archived, kept for reference)
- Read developer handbook: [`docs/developer-handbook.md`](../developer-handbook.md)
...
- **Full rules:** See [`docs/_archive/tooling-notes/project-context.md`](../_archive/tooling-notes/project-context.md) (120+ rules — archived, kept for reference)
