...
### Epic 8 — Gamification & Engagement (DNI-12, 4 stories)
...
### Epic 10 — Parent Mode (DNI-14, 5 stories)
...
### Epic 13 — Cloud Sync (DNI-17, 4 stories)
...
### Epic 14 — Settings (DNI-18, 2 stories)

- **DNI-105** — [14.1] General Settings & User Profile *(Done)*
- **DNI-107** — [14.3] Account Management *(Done)*

### Epic 18 — Onboarding & Track Management Overhaul (DNI-128, 0 stories)


### Epic 17 — V1 Roadmap Phase 1: Foundation & Onboarding (DNI-154, 0 stories)


### Epic 19 — Offline-First Architecture & Two-Database Split (DNI-182, 0 stories)


### Epic 20 — Dashboard & Progress Redesign — Multi-Track, Per-Track Isolation (DNI-210, 12 stories)

- **DNI-211** — [20.1] Schema Definition — trackId on 7 Config Tables + paceResetDate *(In)*
- **DNI-212** — [20.2] Track-Scoped DAOs — Add trackId Filters to All Queries *(In)*
- **DNI-213** — [20.3] TrackProgress Domain Models — Variant-Aware Progress Types *(In)*
- **DNI-214** — [20.4] Track-Scoped Providers — Replace Curriculum-Scoped with Per-Track *(In)*
- **DNI-215** — [20.5] Per-Track Scheduler — Scheduler Runs Per-Track, Tasks Carry trackId *(In)*
- **DNI-216** — [20.6] Program Calendar Mock — CalendarPosition Model + Mock Provider *(In)*
- **DNI-217** — [20.7] Dashboard — Stats Row & Unified Task List *(In)*
- **DNI-218** — [20.8] Dashboard — Track Cards (4 Variants) *(In)*
- **DNI-219** — [20.9] Dashboard — Recovery Actions (Jump to Today, Reset Pace) *(In)*
- **DNI-220** — [20.10] Progress Screen & Track Detail Redesign *(In)*
- **DNI-221** — [20.11] Charts & Completion History — Track Filter *(In)*
- **DNI-222** — [20.12] Learning Journey — Curriculum View with Learned/Reviewed Counts *(In)*

### Epic 20 — Offline-First Architecture v2 — Hard-Tier Auth Refactor (DNI-223, 0 stories)


### Epic 21 — Multi-Account Device — Account Switching, Session Management & Deletion (DNI-238, 0 stories)


### Epic 22 — Catch-up & Amnesty System (DNI-255, 0 stories)
