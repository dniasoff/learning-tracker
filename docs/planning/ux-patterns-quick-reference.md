...
**Related:** [Architecture Quick Reference](architecture-quick-reference.md) | [Component Inventory](../component-inventory.md) | [Developer Handbook](../developer-handbook.md)

> ⚠️ **Note — 2026-04-19.** This doc describes UX patterns from February 2026 (pre-Epic-19). Core patterns (user modes, navigation, list items, empty states, accessibility) remain canonical. Minor updates made to reflect the shipped 9-curriculum set and hard-tier auth model. Earlier version linked to `ux-design-specification.md` which has been archived under [`docs/_archive/superseded/`](../_archive/superseded/).
...
**Curriculum Colors (9 curricula — see `lib/core/theme/` for authoritative values):**

- Mishnayos: Blue
- Gemara Bavli: Purple
- Gemara Yerushalmi: Green
- Mishna Berurah: Orange
- Mishneh Torah: Brown (Maimonides' legal code — distinct from Chumash)
- Chumash: Red
- Nach: Teal
- Tanach: Deep Teal
- Mussar: Violet

> The exact hex values drift with theme revisions. Treat `lib/core/theme/curriculum_colors.dart` (or equivalent) as the source of truth; this list is for orientation only.
